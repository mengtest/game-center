...
import github.eddy.game.beans.Player;
import github.eddy.game.beans.Room;
...
public class Application {
    ...
    public static void main(String[] a) throws IOException {
        ...
        while (!room.getStop()) {
            ...
            List<Player> p_wolf_list = room.getPlayersByRole(wolf);
            System.out.println("狼人请杀人:" + room.getPlayerIdsByRole(wolf).toString());
            Integer killNo = Integer.parseInt(app.getInput());

            Player p_prophet = room.getPlayersByRole(prophet).get(0);
            ...
            Player p_witch = room.getPlayersByRole(witch).get(0);
            ...
            if (killORHeal == -1) {
                room.getPlayerById(chooseNo).killedBySkill(room.getPlayersByRole(witch).get(0), SkillEnum.posion);
